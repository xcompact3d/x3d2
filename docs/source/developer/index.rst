...
Particularly, we encourage you to contribute your changes back to the
x3d2 project. The following sections described the process for doing
so.

If you are looking to take part in the project, several options are available

- Report (a) bug(s), suggest improvement(s) or share a user experience.
- Work on the documentation.
- Work on fixing bugs or implementing new features.

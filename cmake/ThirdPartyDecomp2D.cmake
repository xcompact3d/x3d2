...
if (decomp2d_FOUND)
  ...
  ExternalProject_Add(2decomp-${decomp2d_version}
    ...
    CMAKE_ARGS        "-DCMAKE_INSTALL_PREFIX=<INSTALL_DIR>"
                      ...
                      # Fortran module files are only readable by the compiler
                      # that wrote them, so build against ours.
                      "-DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER}"
                      "-DBUILD_SHARED_LIBS=OFF"
                      "-DDOUBLE_PRECISION=${DOUBLE_PRECISION}"
    # Declares the archive to the generator, which otherwise sees targets
    # depend on a file no rule produces.

...
!!   call io_session%close()
  ...
  contains  
    ...
    ! Generic interfaces for session usage
    generic :: write_data => write_data_i8, write_data_integer, write_data_real, &
                            write_data_array_3d
...
contains
  ...
  subroutine base_close(self)
    ...
    error stop "base_close should not be called - use concrete implementation"
  end subroutine base_close

  subroutine base_begin_step(self)
    class(io_file_t), intent(inout) :: self  
    error stop "base_begin_step should not be called - use concrete implementation"
  end subroutine base_begin_step

  subroutine base_end_step(self)
    class(io_file_t), intent(inout) :: self
    error stop "base_end_step should not be called - use concrete implementation" 
  ...
  subroutine base_reader_init(self, comm, name)
    ...
    error stop "base_reader_init should not be called - use concrete implementation"
  ...
  function base_reader_open(self, filename, mode, comm) result(file_handle)
    ...
    error stop "base_reader_open should not be called - use concrete implementation"
  end function base_reader_open

  subroutine base_reader_finalise(self)
    class(io_reader_t), intent(inout) :: self
    error stop "base_reader_finalise should not be called - use concrete implementation"
  ...
  subroutine base_writer_init(self, comm, name)
    ...
    integer, intent(in) :: comm
    character(len=*), intent(in) :: name
    error stop "base_writer_init should not be called - use concrete implementation"
  ...
  function base_writer_open(self, filename, mode, comm) result(file_handle)
    ...
    integer, intent(in) :: comm
    class(io_file_t), pointer :: file_handle
    error stop "base_writer_open should not be called - use concrete implementation"
  end function base_writer_open

  subroutine base_writer_finalise(self)
    class(io_writer_t), intent(inout) :: self
    error stop "base_writer_finalise should not be called - use concrete implementation"
  ...
  subroutine read_data_i8(self, variable_name, value, file_handle)
    ...
    error stop "read_data_i8 should not be called - use concrete implementation"
  ...
  subroutine read_data_integer(self, variable_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "read_data_integer should not be called - use concrete implementation"
  ...
  subroutine read_data_real(self, variable_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "read_data_real should not be called - use concrete implementation"
  ...
  subroutine read_data_array_3d(self, variable_name, array, file_handle, shape_dims, start_dims, count_dims)
    ...
    error stop "read_data_array_3d should not be called - use concrete implementation"
  ...
  subroutine write_data_i8(self, variable_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "write_data_i8 should not be called - use concrete implementation"
  ...
  subroutine write_data_integer(self, variable_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "write_data_integer should not be called - use concrete implementation"
  ...
  subroutine write_data_real(self, variable_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "write_data_real should not be called - use concrete implementation"
  ...
  subroutine write_data_array_3d(self, variable_name, array, file_handle, shape_dims, start_dims, count_dims)
    ...
    integer(i8), intent(in), optional :: start_dims(3)
    integer(i8), intent(in), optional :: count_dims(3)
    error stop "write_data_array_3d should not be called - use concrete implementation"
  ...
  subroutine write_attribute_string(self, attribute_name, value, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "write_attribute_string should not be called - use concrete implementation"
  ...
  subroutine write_attribute_array_1d_real(self, attribute_name, values, file_handle)
    ...
    class(io_file_t), intent(inout) :: file_handle
    error stop "write_attribute_array_1d_real should not be called - use concrete implementation"

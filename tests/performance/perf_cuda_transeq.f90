program perf_cuda_transeq
  ...
  real(dp), parameter :: periodic_bw = 16.0_dp
...
real(dp), device, allocatable :: du_send_s_dev(:, :, :), du_send_e_dev(:, :, :)
  ...
  real(dp), device, allocatable :: d2u_send_s_dev(:, :, :), d2u_send_e_dev(:, :, :)
  real(dp), device, allocatable :: u_send_s_dev(:, :, :), u_send_e_dev(:, :, :)
  real(dp), device, allocatable :: u_recv_s_dev(:, :, :), u_recv_e_dev(:, :, :)
  real(dp), device, allocatable :: v_send_s_dev(:, :, :), v_send_e_dev(:, :, :)
  real(dp), device, allocatable :: v_recv_s_dev(:, :, :), v_recv_e_dev(:, :, :)
...
contains
  ...
  subroutine allocate_fields()
    allocate (u(SZ, n, n_block), v(SZ, n, n_block))

program test_adios2
    ...
    call adios2_writer%write_data("data2D", data_write, file, shape_dims, start_dims, count_dims)
    ...
    if (irank == 0) then
        ...
        call adios2_reader%read_data("data2D", data_read, file, sel_start, sel_count)
